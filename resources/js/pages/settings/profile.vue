      ...
      <b-card :title="$t('your_info')">
        <b-row>
          ...
          <b-colxx md="9" sm="12">
                ...
                <div class="col-md-7">
                  ...
                  <div>
                    <select
                      ...
                      class="form-control"
                    >
                      <option value="" disabled>Please select timezone</option>
                      <option
                        :value="t"
                        v-for="(t, index) in timezones"
                        :key="index"
                      >
                        {{ t }}
                      </option>
              ...
              <div class="form-group row">
                <label class="col-md-3 col-form-label text-md-right">Bio</label>
                <div class="col-md-7">
...
export default {
  ...
  mounted() {
    ...
    const browserTimezone = timezones.find((item) => item == timezone);
    if (!this.form.timezone) {
      //this.form.timezone = browserTimezone.value;
    }
  },
  ...
  methods: {
    ...
    onFileChange(e) {
      ...
      if (!validImageTypes.includes(file["type"])) {
        this.$notify("primary filled", "Warn!", "File is not allowed!", {
          duration: 3000,
          permanent: false,
        });
      } else {
        if (file.size / 100000 > 1) {
          this.$notify(
            "primary filled",
            "",
            "File is not optimized for the sytem. Please reduce reupload with a size of less than 1mb.",
